...
Refer to [defaults/main.yml](https://github.com/ClarifiedSecurity/nova.core/blob/main/nova/core/roles/samba/defaults/main.yml) for the full list of variables, their default values and descriptions.
