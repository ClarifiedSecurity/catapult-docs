...
Refer to the to the [templated config file](https://github.com/ClarifiedSecurity/nova.core/blob/main/nova/core/roles/keycloak/templates/config.j2) for more details on what variables can be used.
